...
using Reservas.Teste.MockData;
using Microsoft.AspNetCore.JsonPatch;
using Microsoft.VisualStudio.TestPlatform.ObjectModel.Utilities;



namespace Reservas.Teste.Controllers
{
    public class ReservasControllerTeste
    {
        [Fact]

        public void GetTodasReservas_DeveRetornarstatus200()
        {
            //Arrange - Organizar
        ...
        [Fact]
        public void GetReservaPorId_DeveRetornarStatus200_QuandoEncontrar()
        {
            //Arrange - Organizar
        ...
        [Fact]
        public void PutReserva_DeveRetornarStatus200QuandoAtualizado()
        {
            //Arrange - Organizar
